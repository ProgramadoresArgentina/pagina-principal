...
export const metadata: Metadata = {
  title: "Libros y Artículos - Club Programadores Argentina",
  description: "Accede a nuestra biblioteca exclusiva de libros técnicos y artículos de programación disponibles solo para miembros del Club Programadores Argentina.",
  keywords: [
    "libros programación",
  ...
  openGraph: {
    title: "Libros y Artículos - Club Programadores Argentina",
    description: "Accede a nuestra biblioteca exclusiva de libros técnicos y artículos de programación.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Libros y Artículos - Club Programadores Argentina",
      },
    ],
    locale: "es_AR",
    type: "website",
    ...
    <>
      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
          <main>
            {/* hero area start */}
            <div className="it-about-area it-about-ptb pt-150 pb-40 p-relative">
            ...
            {/* biblioteca area start */}
            <div className="it-benifit-area p-relative pb-120">
              <div className="container container-1230">
                <div className="it-benifit-bg pb-120 z-index-1" style={{ paddingTop: '20px' }}>
                  <BibliotecaList />
                </div>
              </div>
            </div>
