...
export const PROJECT_QUOTE_QUESTIONS: QuoteQuestion[] = [
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: '1-3', label: '1 a 3 pantallas', price: { minUsd: 400, maxUsd: 800 } },
      { id: '4-7', label: '4 a 7 pantallas', price: { minUsd: 800, maxUsd: 1800 } },
      { id: '8-12', label: '8 a 12 pantallas', price: { minUsd: 1800, maxUsd: 4000 } },
      { id: '13+', label: '13 o más pantallas', price: { minUsd: 4000, maxUsd: 8000 } },
    ],
  },
  {
    id: 'platform',
    ...
    options: [
      ...
      { id: 'mobile', label: 'Solo app para celular', price: { minUsd: 1500, maxUsd: 4000 } },
      { id: 'both', label: 'Sitio web + app para celular', price: { minUsd: 2500, maxUsd: 6500 } },
    ],
  },
  {
    id: 'auth',
    ...
    options: [
      ...
      { id: 'basic', label: 'Sí, login y registro básico', price: { minUsd: 400, maxUsd: 1000 } },
      { id: 'roles', label: 'Sí, con diferentes tipos de usuarios (admin, cliente, etc.)', price: { minUsd: 800, maxUsd: 2000 } },
    ],
  },
  {
    id: 'adminPanel',
    ...
    options: [
      ...
      { id: 'basic', label: 'Sí, un panel básico para gestionar contenido', price: { minUsd: 600, maxUsd: 1500 } },
      { id: 'advanced', label: 'Sí, un panel completo con reportes y control de permisos', price: { minUsd: 1200, maxUsd: 3000 } },
    ],
  },
  {
    id: 'payments',
    ...
    options: [
      { id: 'no', label: 'No', price: { minUsd: 0, maxUsd: 0 } },
      { id: 'oneTime', label: 'Sí, pagos de una sola vez', price: { minUsd: 600, maxUsd: 1500 } },
      { id: 'subscriptions', label: 'Sí, suscripciones mensuales o recurrentes', price: { minUsd: 1200, maxUsd: 2800 } },
    ],
  },
  {
    id: 'integrations',
    ...
    options: [
      ...
      { id: '1-2', label: 'Sí, 1 a 2 conexiones con otras herramientas', price: { minUsd: 500, maxUsd: 1500 } },
      { id: '3-5', label: 'Sí, 3 a 5 conexiones', price: { minUsd: 1200, maxUsd: 3000 } },
      { id: '6+', label: 'Sí, 6 o más conexiones', price: { minUsd: 2500, maxUsd: 6000 } },
    ],
  },
  {
    id: 'ai',
    ...
    options: [
      { id: 'no', label: 'No', price: { minUsd: 0, maxUsd: 0 } },
      { id: 'basic', label: 'Sí, automatización simple o chatbot básico', price: { minUsd: 600, maxUsd: 1800 } },
      { id: 'advanced', label: 'Sí, IA avanzada con aprendizaje automático', price: { minUsd: 2000, maxUsd: 6000 } },
    ],
  },
  {
    id: 'extra',
    ...
    allowEmpty: true,
    options: [
      { id: 'multilang', label: 'Múltiples idiomas (español e inglés)', price: { minUsd: 250, maxUsd: 600 } },
      { id: 'seo', label: 'Optimización para buscadores (Google)', description: 'Para que tu sitio aparezca mejor en las búsquedas.', price: { minUsd: 300, maxUsd: 800 } },
      { id: 'analytics', label: 'Estadísticas y seguimiento de visitantes', price: { minUsd: 200, maxUsd: 500 } },
      { id: 'cms', label: 'Sistema para que puedas editar contenido fácilmente', price: { minUsd: 600, maxUsd: 1500 } },
      { id: 'migrations', label: 'Pasar información de un sistema viejo al nuevo', price: { minUsd: 500, maxUsd: 2000 } },
      { id: 'support', label: 'Soporte y mantenimiento inicial', description: 'Ayuda para resolver problemas y mantener el sistema funcionando.', price: { minUsd: 400, maxUsd: 1000 } },
    ],
  },
];
